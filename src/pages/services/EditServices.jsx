...
function EditServices({ getNews, editId, data }) {
  ...
  const EditNews = async (e) => {
    ...
    formdatanews.append("images", editImages || dataxon?.images);
    formdatanews.append("title_uz", editNameUz || dataxon?.title_uz);
    formdatanews.append("text_uz", editTextUz || dataxon?.text_uz);
    formdatanews.append("author", editAuthor || dataxon?.author);
